export const REV_REG_TYPE = 'CredentialStatusList2017';
...
export const CREDENTIAL_ID = '@id';
export const CREDENTIAL_CONTEXT = '@context';
export const CREDENTIAL_TYPE = '@type';
export const INFRA_DID_METHOD = 'infra';
export const DID_QUALIFIER = `did:${INFRA_DID_METHOD}:`;
export const BLOB_QUALIFIER = `blob:${INFRA_DID_METHOD}:`;
export const REV_REG_QUALIFIER = `rev-reg:${INFRA_DID_METHOD}:`;
