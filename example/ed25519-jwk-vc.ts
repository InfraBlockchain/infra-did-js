...
async function main() {
  ...
  const conf = {
    ...
    cryptoInfo: CRYPTO_INFO.ED25519_JWK,
  };
  ...
  const DIDSet = await InfraSS58.createNewSS58DIDSet(networkId, CRYPTO_INFO.ED25519_JWK);
  ...
  vc.addContext('https://w3c.github.io/vc-jws-2020/contexts/v1');
  ...
  vp.addContext('https://w3c.github.io/vc-jws-2020/contexts/v1');
