...
async function main() {
  ...
  const conf = {
    ...
    cryptoInfo: CRYPTO_INFO.ED25519_2020,
  };
  ...
  const DIDSet = await InfraSS58.createNewSS58DIDSet(networkId, CRYPTO_INFO.ED25519_2020);
  ...
  vc.addContext('https://w3id.org/security/suites/ed25519-2020/v1');
