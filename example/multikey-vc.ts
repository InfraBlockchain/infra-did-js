...
async function main() {
  ...
  const conf = {
    ...
    cryptoInfo: CRYPTO_INFO.MULTIKEY,
  };
  ...
  const DIDSet = await InfraSS58.createNewSS58DIDSet(networkId, CRYPTO_INFO.MULTIKEY);
  ...
  vc.addContext('https://w3id.org/security/data-integrity/v2');
  ...
  vp.addContext('https://w3id.org/security/data-integrity/v2');
